...
public class Configuration extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckBox cbDiscreto = (CheckBox)findViewById(R.id.cbDiscreto);
        CheckBox cbNumeroSombreados = (CheckBox)findViewById(R.id.cbNumeroSombreados);
//        Spinner divisiones = (Spinner)findViewById(R.id.divisiones);
        ...
        cbDiscreto.setChecked(Sys.getBoolean(Sys.SETTINGS_DISCRETO,false, Configuration.this));
        cbNumeroSombreados.setChecked(Sys.getBoolean(Sys.SETTINGS_NUMEROS_SOMBREADOS,false, Configuration.this));
...
//        });
        ...
        cbDiscreto.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Sys.save(Sys.SETTINGS_DISCRETO, isChecked, Configuration.this);
            }
        });
        ...
        cbNumeroSombreados.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Sys.save(Sys.SETTINGS_NUMEROS_SOMBREADOS, isChecked, Configuration.this);
            }
        });
